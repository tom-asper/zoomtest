...
class CommentList extends HookWidget {
  ...
  const CommentList({super.key, required this.zoom, required this.eventListener});
  ...
  Widget build(BuildContext context) {
    ...
    useEffect(() {
      ...
      final chatNewMessageNotify = emitter.on(EventType.onChatNewMessageNotify, (data) async {
        ZoomVideoSdkChatMessage newMessage = ZoomVideoSdkChatMessage.fromJson(jsonDecode(data.toString()));
      ...
      final deleteChatMessageNotify = emitter.on(EventType.onChatDeleteMessageNotify, (data) async {
        data = data as Map;
        var toRemove = [];
                  ...
                  Flexible(
                    ...
                    child: RichText(
                      text: TextSpan(
                        children: <TextSpan>[
                          TextSpan(
                            text: '${chatMessages.value[index].senderUser.userName}: ',
